...
public class PartitionSchemeQuickSelect {
    ...
    public static void main(String[] args) {
        int result = PartitionSchemeQuickSelect.findKthSmallestNumber(new int[] {1,5,12,2,11,5}, 3);
        System.out.println("Kth smallest number is: " + result);

        result = PartitionSchemeQuickSelect.findKthSmallestNumber(new int[] {1,5,12,2,11,5}, 4);
        System.out.println("Kth smallest number is: " + result);
    }
}
